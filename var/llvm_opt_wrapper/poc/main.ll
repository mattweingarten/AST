...
@.str.3 = private unnamed_addr constant [16 x i8] c"hello from foo\0A\00", align 1
...
define dso_local i32 @main() #0 {
  ...
  %5 = call i32 (...) bitcast (i32 ()* @foo to i32 (...)*)()
...
define dso_local i32 @foo() #0 {
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.3, i64 0, i64 0))
  ret i32 1337
}
